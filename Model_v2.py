...
# Example usage
user_prompt = "suppliers of iphone 15 in Kenya"
...
# Filter suppliers based on website availability and valid product price
filtered_suppliers = [
    supplier for supplier in supplier_data
    if supplier['website'] != 'N/A' and supplier['product_info'] is not None and supplier['product_info']['price'] not in ["Price not found", "Request failed", None]
]
...
# Output the filtered and sorted suppliers
